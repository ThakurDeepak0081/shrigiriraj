...
import bankeBihariImg from '@/assets/banke-bihari.jpg';
import vaishnodeviImg from '@/assets/vaishno-devi.jpg';
import iskconImg from '@/assets/iskcon-temple.jpg';
      ...
      <div className="container mx-auto">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-muted-foreground text-lg leading-relaxed">
            Our prime location in the heart of Vrindavan gives you easy access to the most 
            sacred temples and spiritual sites in the holy dham.
          </p>
        </div>
